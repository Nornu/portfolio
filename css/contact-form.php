...
<section class="moi">
    ...
    <div class="introduction">
        <p><strong>Me Contacter</strong> N'h&eacute;sitez pas &agrave; remplir le formulaire pour me contacter.</p>
    </div><!--
    ...
    <div class="contenu blog full_width">
        <div class="cadre cadre_moi full_height load_<?php $rand_key = array_rand($sSpeed,1); $speed = $sSpeed[$rand_key]; echo $speed ?>">
